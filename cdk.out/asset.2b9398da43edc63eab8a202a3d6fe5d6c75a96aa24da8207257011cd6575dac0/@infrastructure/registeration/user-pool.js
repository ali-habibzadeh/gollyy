...
class AppUserPool {
    ...
    addTriggers() {
        this.userPool.addTrigger(aws_cognito_1.UserPoolOperation.PRE_SIGN_UP, new lambda_factory_1.LambdaFactory(this.scope, handlers_list_1.Handlers.RegistrationHandler, {
